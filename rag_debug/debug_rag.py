...
SYNTHETIC_CHUNKS = [
    ...
    # Regression case for the exact bug found in the real corpus: a drug name
    # stored in all caps, queried in lowercase (mirrors "AC FAST").
    Chunk(chunk_id="gamma-dosage", drug_name="AC FAST", section="Dosage and Administration",
          source_file="synthetic_gamma.txt",
          text="AC FAST is taken as one tablet every 6 hours as needed."),
]
...
TEST_CASES = [
    ...
    {"id": "Q6", "question": "what is the dosage of ac fast?", "drug": "ac fast",
     "target_sections": "Dosage and Administration", "gold_topic": "", "expected_keywords": "", "expected_chunk": ""},
]
